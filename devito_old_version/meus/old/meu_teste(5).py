...
# Define true and initial model ############################################################## Criacao dos modelos
...
################################################################################################# Criacao da onda do source e dos recievers
...
################################################################################################################### solver: operator. calcula rec.data e u.data
...
import scipy
def fwi_gradient(m_in):    ############################### Calculo de um gradiente (ainda nao completo, falta alguns constrains de vel min e max)
...
################################################################################ Calculo de todos os gradientes
